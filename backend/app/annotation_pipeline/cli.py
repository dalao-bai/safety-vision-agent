...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--config", default="../configs/annotation_api_config.json")
    parser.add_argument("--rule-blocks", default="../configs/rules/four_openings_edges_rule_blocks.example.json")
    parser.add_argument("--image-dir", default="../uploads")
    parser.add_argument("--output-dir", default="../outputs/annotation_pipeline")
    ...
    parser.add_argument("--db-records-dir", default="../outputs/annotation_db/records")
